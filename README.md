...
The following is a description of my experience completing the project:
...
## License
The project is **NOT** liscensed und the following liscense. [MIT License](License.md).  This liscense and link to it are for demonstration purposed only.

## Features
My refactor of the Horiseon website includes a custom SVG file that resolves my clients desire for a simple two color text branding of the compnay name while providing screen readers with content that doesn't lead to an off-color utterance when it is supposed to be the companies name.
